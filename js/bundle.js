...
/* harmony import */ var _modules_helpersFunction__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/helpersFunction */ "./js/modules/helpersFunction.js");
...
function forms(form, modalSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    ...
    (0,_modules_modals__WEBPACK_IMPORTED_MODULE_0__.openModal)(modalSelector, modalTimerId);
    ...
    setTimeout(() => {
      ...
      (0,_modules_modals__WEBPACK_IMPORTED_MODULE_0__.closeModal)(modalSelector);
    }, 2500);
  }
  ...
  function postForm(form) {
    form.addEventListener('submit', event => {
      ...
      (0,_modules_helpersFunction__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json).then(data => {
        console.log(data);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_helpersFunction__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/helpersFunction */ "./js/modules/helpersFunction.js");
...
function slider() {
  ...
  const setupSlider = function () {
    ...
    function setNumSlide(i) {
      ...
      indCurrent.textContent = (0,_modules_helpersFunction__WEBPACK_IMPORTED_MODULE_0__.setZero)(index); // сюда активацию дотца запихнуть

      indTotal.textContent = (0,_modules_helpersFunction__WEBPACK_IMPORTED_MODULE_0__.setZero)(slides.length);
    ...
    setNumSlide(); //Add eventListener for button
  ...
  (0,_modules_helpersFunction__WEBPACK_IMPORTED_MODULE_0__.getData)('http://localhost:3000/slider').then(data => {
...
function timer(deadLine) {
  ...
  function setClock(selector, endTime) {
    ...
    function updateClock() {
      ...
      days.innerHTML = (0,_modules_helpersFunction__WEBPACK_IMPORTED_MODULE_0__.setZero)(time.days);
      hours.innerHTML = (0,_modules_helpersFunction__WEBPACK_IMPORTED_MODULE_0__.setZero)(time.hours);
      minutes.innerHTML = (0,_modules_helpersFunction__WEBPACK_IMPORTED_MODULE_0__.setZero)(time.minutes);
      seconds.innerHTML = (0,_modules_helpersFunction__WEBPACK_IMPORTED_MODULE_0__.setZero)(time.seconds);
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(_modules_modals__WEBPACK_IMPORTED_MODULE_4__.openModal, 300000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_6__.default)(); // helperFunctions();

  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.default)('.modal', modalTimerId);
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.openModal)('.modal', modalTimerId);
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.closeModal)('.modal');
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__.default)('2021-05-29');
});
}();
/******/ })()
;
